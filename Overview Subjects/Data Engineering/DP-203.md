...
If we want to temorarely store data to be used later in the flow (like if we use dataframes), we can use Cash Sink that will store data in the Spark Cash.
