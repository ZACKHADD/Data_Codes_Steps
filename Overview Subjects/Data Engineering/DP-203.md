...
https://stackoverflow.com/questions/49077303/how-to-populate-fact-table-with-surrogate-keys-from-dimensions
...
```SQL
                INSERT INTO employee (id, name, salary, start_date, end_date, is_active)
                    ...
                    WHERE action = 'UPDATE';
```
CDC, logs in relational DBs, use of hash functions to determine changes in unique columns ...

##### Using ETL (ADF):

##### Using Hash function to detecte rows:
